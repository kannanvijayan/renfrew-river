...
import { AnimalId, AnimalData } from "./types/animal_data";
...
export { AnimalId, AnimalData, CellCoord, CellInfo, Elevation, TurnNo, WorldDims, GameConstants, GameSettings, TurnStepResult, };
