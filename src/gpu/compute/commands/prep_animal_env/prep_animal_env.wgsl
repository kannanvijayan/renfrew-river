...
struct AnimalEnvData {
  elev: u32,
  animal_id: AnimalId,
}
struct AnimalEnvironment {
  elev_cur: array<AnimalEnvData, 1>,
  elevs_n_ne: array<AnimalEnvData, 3>,
  elevs_ne_se: array<AnimalEnvData, 3>,
  elevs_se_s: array<AnimalEnvData, 3>,
  elevs_s_sw: array<AnimalEnvData, 3>,
  elevs_sw_nw: array<AnimalEnvData, 3>,
  elevs_nw_n: array<AnimalEnvData, 3>,
  // Pad out to 128 entries.
  // 128 - (1 + 3*6) = 128 - 19 = 109
  padding: array<u32, 109>,
}
...
struct ElevationsMap {
  values: array<ElevationX2>,
}
struct AnimalEnvironmentList {
  values: array<AnimalEnvironment>,
}
struct WhyList {
  values: array<u32>,
}
...
@group(0) @binding(1)
var<storage, read> in_animal_data: AnimalDataList;

@group(0) @binding(2)
var<storage, read> in_animal_position_map: CurrentPositionMap;

@group(0) @binding(3)
var<storage, read> in_elevations_map: ElevationsMap;

@group(0) @binding(4)
var<storage, read_write> out_environ_list: AnimalEnvironmentList;
